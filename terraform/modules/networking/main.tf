...
# Two public subnets across different AZs (required for ALB)
# ECS tasks run here with assign_public_ip=true so they can reach ECR without a NAT gateway.
...
resource "aws_security_group" "alb" {
  ...
  description = "Internet-facing ALB: allow HTTP (80) and test listener (8080)"
  vpc_id      = aws_vpc.main.id
